...
getData(String url) async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (currentData.spectro2.id != nullData) {
        Spectro2 newSpectro = currentData.spectro2;
        saveSpectro2Data(newSpectro, spectroGraph2Archive, newSpectro.id);
        spectro2Controller.add(newSpectro);
      }
    } else {
...
saveSpectro2Data(Spectro2 newSpectro, List<List<Spectro2>> graph, int id) {
  graph[id - 1].add(newSpectro);
}
